            ...
            <div v-if="userHasRole('yönetici')">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div class="rounded-xl bg-white dark:bg-gray-900 p-6 border border-gray-200 dark:border-gray-800">
                        <div class="font-bold text-lg mb-2 text-gray-800 dark:text-white">Masalar</div>
                        <div class="text-xs text-gray-500 mb-2">Doluluk: %{{ occupancy }}</div>
                        <div class="flex flex-wrap gap-2">
                            <span v-if="props.stats.totalTables === 0" class="text-gray-400">Henüz masa
                                bulunmuyor</span>
                            <span v-else class="text-gray-700 dark:text-gray-300">Toplam {{ props.stats.totalTables }}
                                masa,
                                {{
                                    props.stats.occupiedTables }} dolu</span>
                        </div>
                    </div>
                    <div class="rounded-xl bg-white dark:bg-gray-900 p-6 border border-gray-200 dark:border-gray-800">
                        ...
                        <ul v-else class="divide-y divide-gray-200 dark:divide-gray-800">
                            <li v-for="order in props.lastOrders" :key="order.id"
                                ...
                                <div>
                                    ...
                                    <span class="ml-2 text-gray-500 dark:text-gray-400">{{ order.table?.name || 'Masa Yok'
                                        }}</span>
